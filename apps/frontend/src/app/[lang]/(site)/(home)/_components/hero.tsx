...
export function Hero({
  ...
  const { chat, hero, profile, skills: skillsContent, stats } = getHomeContent(useLocale())
      ...
      <Stagger className="home-hero-copy" stagger={0.08} delay={0.08} onMount>
        ...
        <StaggerItem variant="rise-visible">
          <div className="home-hero-actions">
            <LocaleLink className="button button-primary" href="/projets">
              {hero.primaryAction} <ArrowRight size={16} />
            </LocaleLink>
            <LocaleLink className="button button-secondary" href="/contact">
      ...
      <aside className="home-hero-aside" aria-label="Profil, compétences et assistant">
        ...
        >
          ...
          <p className="chat-retention">
            {retentionNotice} <LocaleLink href="/confidentialite">{chat.privacyLink}</LocaleLink>
          </p>
        </m.div>
      </aside>
